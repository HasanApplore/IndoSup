    ...
    <div className="min-h-screen bg-[#fbf5ea]">
      ...
      <section className="py-16 md:py-20 bg-[#fbf5ea]">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
          ...
          >
            <motion.div 
              className="bg-[#3e4e66] rounded-xl p-4 shadow-lg text-center hover:shadow-2xl transition-all duration-300 cursor-pointer group relative overflow-hidden border-2 border-[#E5E7EB] hover:border-[#FFC600]"
              whileHover={{ y: -2 }}
              whileTap={{ scale: 0.98 }}
            ...
            {solutions.map((solution, index) => (
              ...
              >
                ...
                <div className="flex-1">
                  ...
                  <motion.div 
                    className="bg-[#3e4e66] rounded-xl p-8 shadow-lg border border-[#475466] h-[500px] flex flex-col overflow-hidden transition-all duration-300 hover:shadow-xl"

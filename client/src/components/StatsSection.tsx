...
export default function StatsSection() {
  ...
  return (
    <section className="relative py-20 bg-neutral-dark overflow-hidden">
        ...
        >
          {stats.map((stat, index) => (
            ...
            >
              ...
              {/* Decorative Line */}
              <motion.div
                className="w-12 h-0.5 bg-primary mx-auto mt-4 opacity-0 group-hover:opacity-100 transition-opacity duration-300"
                initial={{ scaleX: 0 }}
